...
namespace DatabaseFirstADO
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            int result2 = myTableService2.InsertData(myTableService2.connectionString, "customers", new Customer(0, "Bill", "Gates", "billgates@microsoft.com", new DateTime(1962, 10, 11), "001239812789", "0011923789231"));
            Console.WriteLine($"Inserted {result2} row(s)!");
            Console.Clear();
            myTableService2 = new MyTableService<Customer>(sql, "Customer");
            result2 = myTableService2.UpdateData(myTableService2.connectionString, "customers", 4, new Customer(0, "Billakos", "Gateakis", "billakos@gateakos.com", new DateTime(1900,2,3), "1234", "1234"));
            Console.WriteLine($"Updated {result2} row(s)!");

            result2 = myTableService2.DeleteData(myTableService2.connectionString, "customers", 15);
